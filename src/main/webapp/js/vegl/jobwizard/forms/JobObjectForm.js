...
Ext.define('vegl.jobwizard.forms.JobObjectForm', {
    ...
    constructor: function(wizardState) {
        ...
        this.callParent([{
            ...
            items: [{
                ...
                itemId : 'name',
                fieldLabel: 'Job Name',
                value : Ext.util.Format.format('VGML Job {0}', Ext.Date.format(new Date(), 'Y-m-d g:i a')),
                plugins: [{
                    ptype: 'fieldhelptext',
    ...
    getHelpInstructions : function() {
        ...
        return [Ext.create('portal.util.help.Instruction', {
            ...
            anchor : 'bottom',
            description : 'If selected, VGML will send you a notification email on job completion.'
        })];
    }
});